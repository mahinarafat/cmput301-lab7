...
// You can also use anything() in place of is(instanceOf(String.class))
    ...
    public void testActivitySwitch() {
        ...
        onView(withId(R.id.textView_cityName)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()));
    }
    @Test
    public void testCityNameConsistency() {
        ...
        onView(withText("Edmonton")).perform(click());
        onView(withId(R.id.textView_cityName)).check(ViewAssertions.matches(withText("Edmonton")));
    }
    @Test
    public void testBackButton() {
        ...
        onView(withId(R.id.button_add)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()));
    }
}
